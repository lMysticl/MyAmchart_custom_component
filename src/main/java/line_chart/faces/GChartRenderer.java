...
import line_chart.model.GChartModel;
import line_chart.model.GChartModelRow;
...
public class GChartRenderer extends CoreRenderer {
    ...
    public static final String RENDERER_TYPE = "GChartRenderer";
    ...
    protected void encodeScript(FacesContext context, GChart chart) throws IOException {
        ...
        wb.attr("type", m.getChartType().getChartName());
