...
@ResourceDependencies({
        ...
        @ResourceDependency(library = "js", name = "gchart.js"),
        @ResourceDependency(library = "css", name = "gchart.css") })
public class GChart extends UIOutput implements Widget,ClientBehaviorHolder {
    public static final String COMPONENT_TYPE = "GChart";
    public static final String COMPONENT_FAMILY = "components";
    private static final Collection<String> EVENT_NAMES = Collections.unmodifiableCollection(Arrays.asList("select"));
    public static final String DEFAULT_TYPE = "select";
